...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/08 22:37:18 by ykuru             #+#    #+#             */
/*   Updated: 2022/12/10 21:49:04 by ykuru            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* static int walking(int keycode, t_data *data, int x)
{
	if (keycode  == 2 || keycode  == 0){
        if (data->map[data->player_y][data->player_x + x] == '1')
            return (0);
		else if (data->map[data->player_y][data->player_x + x] == 'C')
		{
			data->map[data->player_y][data->player_x + x] = '0';
			data->coin_collected++;
		}
		else if (data->map[data->player_y][data->player_x + x] == 'E')
		{
			exit_door(data);
			return (0);
		}
    ...
    if (keycode  == 13 || keycode  == 1){
       	if (data->map[data->player_y - x][data->player_x] == '1')
	   		return (0);
       	else if (data->map[data->player_y - x][data->player_x] == 'C')
	   	{
			data->map[data->player_y - x][data->player_x] = '0';
			data->coin_collected++;
		}
       	else if (data->map[data->player_y - x][data->player_x] == 'E')
		{
			exit_door(data);
			return (0);
		}
